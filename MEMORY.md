...
This repo's `.github/workflows/` enforces VSDD on itself. Six workflows, mirroring the pipeline. For bot-trust predicates per event type, see [`.github/SAFE-CONTEXT-PREDICATES.md`](.github/SAFE-CONTEXT-PREDICATES.md).
